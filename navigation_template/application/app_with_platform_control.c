...
int main(int argc, char** argv)
{
    ...
    activity_t drive_activity, lidar_activity;
    activity_t proprioception_activity, control_activity;
    ...
    mobile_platform_control_activity_lcsm.create(&control_activity, "control_activity");
    mobile_platform_control_activity_lcsm.configure(&control_activity, &variable_table);

    hokuyo_activity_lcsm.create(&lidar_activity, "lidar_activity");
    hokuyo_activity_lcsm.configure(&lidar_activity, &variable_table);
    ...
    // Instatiate  threads
    thread_t thread_drive, thread_control, thread_lidar, thread_navigation;
    create_thread(&thread_drive, "drive", application_data.thread_cycle_time_in_ms.drive);  
    create_thread(&thread_lidar, "lidar", application_data.thread_cycle_time_in_ms.lidar);
    create_thread(&thread_control, "control", application_data.thread_cycle_time_in_ms.control);
    ...
    register_activity(&thread_lidar, &lidar_activity, NULL);
    register_activity(&thread_control, &control_activity, NULL);
    ...
    mobile_platform_control_activity_params_t *control_activity_params =
        (mobile_platform_control_activity_params_t *) control_activity.conf.params;
    mobile_platform_control_activity_coordination_state_t *control_activity_coord_state =
        (mobile_platform_control_activity_coordination_state_t *) control_activity.state.coordination_state;
    ...
    hokuyo_activity_continuous_state_t *lidar_activity_continuous_state =
        (hokuyo_activity_continuous_state_t *) lidar_activity.state.computational_state.continuous; 
    hokuyo_activity_params_t *lidar_activity_params =
        (hokuyo_activity_params_t *) lidar_activity.conf.params; 
    hokuyo_activity_coordination_state_t *lidar_activity_coord_state =
        (hokuyo_activity_coordination_state_t *) lidar_activity.state.coordination_state;
    ...
    control_activity_coord_state->execution_request = &execution_request;
    control_activity_coord_state->deleting_request = &deleting_request;
    
    

    lidar_activity_coord_state->execution_request = &execution_request;
    lidar_activity_coord_state->deleting_request = &deleting_request;
    ...
    strcpy(lidar_activity_params->hokuyo_params.configuration_file, application_data.configuration_file.lidar);
    strcpy(proprioception_activity_params->configuration_file, application_data.configuration_file.proprioception);
    strcpy(control_activity_params->configuration_file, application_data.configuration_file.control);
    ...
    mobile_platform_control_activity_lcsm.destroy(&navigation_activity);
    ...
    application_data_t *application_data, int *status)
{
     param_array_t param_array[] = 
    {
        ...
        {.param_name="thread_cycle_time_in_ms/navigation", 
            ...
            .param_type=PARAM_TYPE_INT},
        {.param_name="thread_cycle_time_in_ms/control", 
            .param_pointer=&application_data->thread_cycle_time_in_ms.control, 
            .param_type=PARAM_TYPE_INT},
        ...
        {.param_name="configuration_file/proprioception", 
            ...
            .param_type=PARAM_TYPE_CHAR},
        {.param_name="configuration_file/control", 
            .param_pointer=application_data->configuration_file.control, 
            .param_type=PARAM_TYPE_CHAR},
